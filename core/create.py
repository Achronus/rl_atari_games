...
class SetModels:
    ...
    def __create_dqn(self) -> DQN:
        ...
        return DQN(self.env_details, model_params, params, self.devices, self.seed, self.im_type)
    ...
    def __create_rainbow_dqn(self) -> RainbowDQN:
        ...
        return RainbowDQN(self.env_details, model_params, params, buffer_params,
                          self.devices, self.seed, self.im_type)
    ...
    def __create_ppo(self) -> PPO:
        ...
        return PPO(self.env_details, model_params, params, self.devices, self.seed, self.im_type)
